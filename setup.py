...
setup(
    ...
    install_requires=["requests~=2.20", "python-dateutil~=2.7", "click~=7.0"],
    extras_require={
        "streaming": ["timeout-decorator==0.4.1", "google-cloud-pubsub==0.39.1"],
        "dev": ["pytest~=4.3.0"],
    },
    entry_points={
        "console_scripts": [
            "bitcoin-etl=bitcoinetl.cli:cli",
        ],
    },
    project_urls={
